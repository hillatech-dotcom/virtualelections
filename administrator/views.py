...
from administrator.utils import render_to_pdf
from django.template import Context
from django.template.loader import render_to_string
import json  # Not usedimport pdfvie
...
class GeneratePdf(View):
    ...
    def get(request,inflow_id):
        template= 'admin/print.html'          
...
class PrintVoters(View):
    def get(request,context):
        voter=Voter.objects.all()
        template_name='admin/printvoters.html'
        context={}
        if not voter.exists():
            context['code'] = 404
        else:
...
def view_voter_by_id(request):
    ...
    if not voter.exists():
        ...
        #context['registration_no']= voter.admin.registration_no
        context['first_name'] = voter.admin.first_name
        context['last_name'] = voter.admin.last_name
        context['phone'] = voter.phone
        context['phone'] = voter.phone
